...
window.addEventListener('load', function() {
	...
	var SaveFile = function(saveBuffer) {
		...
		var SeedTable = new Uint16Array([0x0000, 0x1021, 0x2042, 0x3063, 0x4084, 0x50a5, 0x60c6, 0x70e7, 0x8108, 0x9129, 0xa14a, 0xb16b, 0xc18c, 0xd1ad, 0xe1ce, 0xf1ef,
			...
			BWFooter = {offset: 0x23f00, size: 0x8c, checkSumOffset: 0x23f9a, signatureCheckSumOffset: 0x23f42, signatureBlockSize: 0x658},
			BlockSizes = {dp: 0xc0ec, plat: 0xcf18, hgss: 0xf618, bw: 0x23f8c},
			OffsetsSign = {dp: 0x5904, plat: 0x5ba8, hgss: 0x4538, bw: 0x1c100},
			BlockOffsets = {block1: 0, block2: 0x40000, block2bw: 0x24000},
			UsableBlocks = {none: 0, block1: 1, block2: 2, both: 3},
			OffsetsSavCnt = {dp: 0xc0f0, plat: 0xcf1c, hgss: 0xf618, bw: 0x23f8c},
			ChkSumFooterOffsets = {dp_pt: 0x12, hgss_bw: 0xe};
